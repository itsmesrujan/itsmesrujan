...
- 🌱 I secured experience on multiple domains like security ([smart card](https://en.wikipedia.org/wiki/Smart_card)), [telecom](https://en.wikipedia.org/wiki/Telecommunications), [aero](https://en.wikipedia.org/wiki/Aero), camera systems ([surveillance camera](https://en.wikipedia.org/wiki/Surveillance)), travel technology ([airline](https://en.wikipedia.org/wiki/Airline)) and storage domain([flash memory](https://en.wikipedia.org/wiki/Flash_memory)) experience.
- 💞️ I’m looking to
