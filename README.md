...
- 🌱 I secured experience on multiple domains like [aero](https://en.wikipedia.org/wiki/Aero), camera systems ([surveillance camera](https://en.wikipedia.org/wiki/Surveillance)), security ([smart card](https://en.wikipedia.org/wiki/Smart_card)), storage domain([flash memory](https://en.wikipedia.org/wiki/Flash_memory)), [telecom](https://en.wikipedia.org/wiki/Telecommunications), and travel technology ([airline](https://en.wikipedia.org/wiki/Airline)) experience.
- 💞️ I’m looking to
